<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <div class="sidebar-card d-none d-lg-flex">
        <img class="sidebar-card-illustration mb-2"
            ...
            alt="...">
        <p class="text-center mb-2"><strong style="text-align: center">BPS Kota jambi</strong><br>Menyediakan kebutuhan
            data bagi pemerintah dan masyarakat.</p>
        <a class="btn btn-success btn-sm" href="https://jambikota.bps.go.id/">Kunjungi Website</a>
    </div>
</ul>
@endcan