...
class CustController extends Controller
{
    ...
    {
        $pelanggan = Customer::all();
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('customer', compact('pelanggan'));
    ...
    public function getAllReport()
    {
        ...
        return view('report', compact('pelanggan', 'job', 'customer', 'asn', 'student', 'lecturer', 'researcher', 'general_job', 'pendidikan', 'education', 'smp', 'sma', 'diploma', 'sarjana', 'magister', 'doktor', 'service', 'service1', 'service2', 'service3', 'service4', 'media', 'media1', 'media2', 'media3', 'media4', 'media5', 'purpose', 'purpose1', 'purpose2', 'purpose3', 'purpose4', 'purpose5','transaction', 'pendingCount', 'servedCount'));
    }
    ...
    public function downloadPDFReport()
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('report', compact('pelanggan', 'job', 'customer', 'asn', 'student', 'lecturer', 'researcher', 'general_job', 'pendidikan', 'education', 'smp', 'sma', 'diploma', 'sarjana', 'magister', 'doktor', 'service', 'service1', 'service2', 'service3', 'service4', 'media', 'media1', 'media2', 'media3', 'media4', 'media5', 'purpose', 'purpose1', 'purpose2', 'purpose3', 'purpose4', 'purpose5', 'transaction', 'pendingCount', 'servedCount'));
