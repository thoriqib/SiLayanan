...
<head>
    ...
    <title>Customer - BPS Kota Jambi</title>
    <style>
        #emp {
...
<body>
    <table>
        <tr>
            <td><img src="{{ asset('pengguna/assets/images/logoBps.png') }}" style="width: 100px; height: 100px"></td>
            <td>
                <h2 style="text-align: center">Badan Pusat Statistik (BPS)</h2>
                <h3 style="text-align: center"><b>Kota Jambi</b></h3>
                <h4 style="text-align: center"><i>Jl. Jambi mana ni?</i></h4>
            </td>
        </tr>
        <tr>
            <td colspan="10">
    ...
    <div class="card-header">
        ...
        <p style="text-align: justify">Buku tamu <strong>BPS - Kota Jambi</strong> merupakan buku yang berisi daftar
            pelanggan yang bertujuan dalam pemenuhan kebutuhan data.
            Buku tamu ini bisa menjadi patokan dalam evaluasi BPS Kota Jambi dalam melayani masyarakat. Berikut ini
    ...
    <div class="card-header">
        ...
        <p style="text-align: center">Belum Dilayani : <strong>{{ $pendingCount }}</strong> kali</p>
        <p style="text-align: center">Total Dilayani : <strong>{{ $servedCount }}</strong> kali</p>
    </div>
    ...
    <table id="emp" border="2">
        <thead class="thead-dark">
            <tr>
                <th>Add-Stat-Whatsapp</th>
                <th>Pelayanan Statistik Terpadu</th>
            </tr>
        </thead>
        <tbody>
            <tr>
