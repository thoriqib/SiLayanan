...
<body>
    <form action="{{ url ('/simpan-bukutamu')}}" method="POST" class="sigin-form">
        ...
        <h2 class="text-center">Badan Pusat Statistik Kota jambi</h2>
        ...
        <div class="form-step">
            ...
            <div class="input-group">
                ...
                <input type="text" name="nipnim" id="nipnim"
                       class="form-control @error('nipnim') is-invalid @enderror"
                       placeholder="Silahkan isi NIP/NIM Anda"
                ...
                @error('nipnim')
                <span class="invalid-feedback" role="alert">
                    <strong style="color: rgb(249, 133, 133)">Harap mengisi NIP/NIM</strong>
                </span>
                @enderror
            </div>            
            <div class="form-group mb-3">
